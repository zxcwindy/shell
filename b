...
users=(webdb root aiapp aiweb kpi root db2inst1 ocdc root hbsale doota ocdc svn doota ocdc ocdc ocdc ocdc ocdc root root david db2inst1 root dacp dacp-dp db2inst1 root oracle gbase)
index=0
position=0
for ip in $hostalias
do
